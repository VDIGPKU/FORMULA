...
# Copyright 2021 VDIGPKU Comfort and Driving Assistance. All rights reserved.
...
def register_voc_in_coco_style(
    ...
    voc2012_trainval_json_path="./datasets/voc_objects_2012_trainval_CAD_coco_style.json"):
...
def register_CAD_FORMULA_pseudo_boxes_for_the_voc2007_trainval_dataset(
    voc2007_json_path="./datasets/voc_2007_trainval_FORMULA_CAD.json",
    voc2007_dataset_name="voc_2007_trainval_FORMULA_CAD"):
...
def register_CAD_FORMULA_pseudo_boxes_for_the_voc2012_trainval_dataset(
    voc2012_json_path="./datasets/voc_2012_trainval_FORMULA_CAD.json",
    voc2012_dataset_name="voc_2012_trainval_FORMULA_CAD"):

    print(f"Registering the '{voc2012_dataset_name}' from the json file {voc2012_json_path}")
    def voc_2012_trainval_dataset_function():
        with open(voc2012_json_path) as infile:
            json_data = json.load(infile)
        return json_data["dataset"]
    detectron2.data.DatasetCatalog.register(
        voc2012_dataset_name, voc_2012_trainval_dataset_function)
    detectron2.data.MetadataCatalog.get(voc2012_dataset_name).thing_classes = ["object",]
    detectron2.data.MetadataCatalog.get(voc2012_dataset_name).evaluator_type = "coco"
...
def register_CAD_FORMULA_pseudo_boxes_for_the_coco20k_trainval_dataset(
    coco20k_json_path="./datasets/coco20k_train_FORMULA_CAD.json",
    coco20k_dataset_name="coco20k_train_FORMULA_CAD"):
...
register_CAD_FORMULA_pseudo_boxes_for_the_voc2007_trainval_dataset()
register_CAD_FORMULA_pseudo_boxes_for_the_voc2012_trainval_dataset()
...
try:
    register_CAD_FORMULA_pseudo_boxes_for_the_coco20k_trainval_dataset()
except:
    print("If failing here, please make sure to construct pseudo-boxes dataset using:\
          >python tools/prepare_coco_FORMULA_CAD_pseudo_boxes_in_detectron2_format.py --pboxes /path/preds.pkl")
#*******************************************************************************
#*******************************************************************************
